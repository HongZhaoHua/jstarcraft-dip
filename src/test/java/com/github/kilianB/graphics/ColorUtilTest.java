...
class ColorUtilTest {
	...
	class AwtToFX {
		@Test
		void black() {
			assertEquals(Color.BLACK, ColorUtil.awtToFxColor(java.awt.Color.BLACK));
		}

		@Test
		void white() {
			assertEquals(Color.WHITE, ColorUtil.awtToFxColor(java.awt.Color.WHITE));
		}

		@Test
		void gray() {
			assertEquals(Color.GRAY, ColorUtil.awtToFxColor(java.awt.Color.GRAY));
		}
		...
		void alpha() {
			...
			assertEquals(new Color(0.5d, 0.5d, 0.5d, 0.3d), ColorUtil.awtToFxColor(new java.awt.Color(0.5f, 0.5f, 0.5f, 0.3f)));
		}
	...
	class FXToAwt {
		@Test
		void black() {
			assertEquals(java.awt.Color.BLACK, ColorUtil.fxToAwtColor(Color.BLACK));
		}

		@Test
		void white() {
			assertEquals(java.awt.Color.WHITE, ColorUtil.fxToAwtColor(Color.WHITE));
		}

		@Test
		void gray() {
			assertEquals(java.awt.Color.GRAY, ColorUtil.fxToAwtColor(Color.GRAY));
		}
