...
public class MatchMultipleImages {
	...
	private void matchMultipleImagesInMemoryManually(BufferedImage... images) {
		...
		PriorityQueue<Result<BufferedImage>> aCandidates = aHashTree.getElementsWithinHammingDistance(aHasher.hash(needle), aThreshold);

		PriorityQueue<Result<BufferedImage>> pCandidates = pHashTree.getElementsWithinHammingDistance(pHasher.hash(needle), pThreshold);
