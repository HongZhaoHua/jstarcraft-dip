...
public abstract class HashingAlgorithm {
	...
	/**
	 * Add a {@link com.github.kilianB.hashAlgorithms.kernel.ImageConverter Filter} to this
	 ...
	 * {@link com.github.kilianB.hashAlgorithms.kernel.ImageConverter Filter} from this
	 * hashing algorithm.
	 * 
	 * <p>
	 * Be aware that filters can only be added or removed until the first hash is
